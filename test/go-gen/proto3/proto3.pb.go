...
type FooMessage struct {
	...
	FRepeatedPackedEnum   []FooEnum              `protobuf:"varint,34,rep,packed,name=f_repeated_packed_enum,json=fRepeatedPackedEnum,proto3,enum=FooEnum" json:"f_repeated_packed_enum,omitempty"`
	FRepeatedUnpackedEnum []FooEnum              `protobuf:"varint,35,rep,name=f_repeated_unpacked_enum,json=fRepeatedUnpackedEnum,proto3,enum=FooEnum" json:"f_repeated_unpacked_enum,omitempty"`
	FTimestamp            *timestamppb.Timestamp `protobuf:"bytes,36,opt,name=f_timestamp,json=fTimestamp,proto3" json:"f_timestamp,omitempty"`
	FDuration             *durationpb.Duration   `protobuf:"bytes,37,opt,name=f_duration,json=fDuration,proto3" json:"f_duration,omitempty"`
}
...
func (x *FooMessage) GetFRepeatedPackedEnum() []FooEnum {
	if x != nil {
		return x.FRepeatedPackedEnum
	}
	return nil
}

func (x *FooMessage) GetFRepeatedUnpackedEnum() []FooEnum {
	if x != nil {
		return x.FRepeatedUnpackedEnum
	}
	return nil
}

func (x *FooMessage) GetFTimestamp() *timestamppb.Timestamp {
	if x != nil {
		return x.FTimestamp
	}
	return nil
...
func (x *FooMessage) GetFDuration() *durationpb.Duration {
	if x != nil {
		return x.FDuration
	}
	return nil
...
type OnlyOneOfField struct {
	...
	//	*OnlyOneOfField_F2
	//	*OnlyOneOfField_F3
	TestOneof isOnlyOneOfField_TestOneof `protobuf_oneof:"test_oneof"`
}

func (x *OnlyOneOfField) Reset() {
	*x = OnlyOneOfField{}
	if protoimpl.UnsafeEnabled {
		mi := &file_test_reader_proto3_proto_msgTypes[6]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *OnlyOneOfField) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*OnlyOneOfField) ProtoMessage() {}

func (x *OnlyOneOfField) ProtoReflect() protoreflect.Message {
	mi := &file_test_reader_proto3_proto_msgTypes[6]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use OnlyOneOfField.ProtoReflect.Descriptor instead.
func (*OnlyOneOfField) Descriptor() ([]byte, []int) {
	return file_test_reader_proto3_proto_rawDescGZIP(), []int{6}
}

func (m *OnlyOneOfField) GetTestOneof() isOnlyOneOfField_TestOneof {
	if m != nil {
		return m.TestOneof
	}
	return nil
...
func (x *OnlyOneOfField) GetF1() int32 {
	if x, ok := x.GetTestOneof().(*OnlyOneOfField_F1); ok {
		return x.F1
	}
	return 0
}

func (x *OnlyOneOfField) GetF2() bool {
	if x, ok := x.GetTestOneof().(*OnlyOneOfField_F2); ok {
		return x.F2
	}
	return false
}

func (x *OnlyOneOfField) GetF3() string {
	if x, ok := x.GetTestOneof().(*OnlyOneOfField_F3); ok {
		return x.F3
	}
	return ""
}

type isOnlyOneOfField_TestOneof interface {
	isOnlyOneOfField_TestOneof()
}

type OnlyOneOfField_F1 struct {
	F1 int32 `protobuf:"varint,1,opt,name=f1,proto3,oneof"`
}

type OnlyOneOfField_F2 struct {
	F2 bool `protobuf:"varint,2,opt,name=f2,proto3,oneof"`
}

type OnlyOneOfField_F3 struct {
	F3 string `protobuf:"bytes,3,opt,name=f3,proto3,oneof"`
}

func (*OnlyOneOfField_F1) isOnlyOneOfField_TestOneof() {}

func (*OnlyOneOfField_F2) isOnlyOneOfField_TestOneof() {}

func (*OnlyOneOfField_F3) isOnlyOneOfField_TestOneof() {}
...
func (x *BazMessage_Nested_NestedMessage) Reset() {
	*x = BazMessage_Nested_NestedMessage{}
	if protoimpl.UnsafeEnabled {
		mi := &file_test_reader_proto3_proto_msgTypes[9]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
var file_test_reader_proto3_proto_rawDesc = []byte{
	...
	,
...
var file_test_reader_proto3_proto_msgTypes = make([]protoimpl.MessageInfo, 10)
var file_test_reader_proto3_proto_goTypes = []any{
	...
	(*OnlyOneOfField)(nil),                  // 8: OnlyOneOfField
	nil,                                     // 9: FooMessage.FMapEntry
	(*BazMessage_Nested)(nil),               // 10: BazMessage.Nested
	(*BazMessage_Nested_NestedMessage)(nil), // 11: BazMessage.Nested.NestedMessage
...
var file_test_reader_proto3_proto_depIdxs = []int32{
	...
	10, // 3: FooMessage.f_nested:type_name -> BazMessage.Nested
	1,  // 4: FooMessage.f_nested_enum:type_name -> BazMessage.Nested.NestedEnum
	9,  // 5: FooMessage.f_map:type_name -> FooMessage.FMapEntry
	4,  // 6: FooMessage.f_repeated_baz_message:type_name -> BazMessage
	0,  // 7: FooMessage.f_repeated_packed_enum:type_name -> FooEnum
	0,  // 8: FooMessage.f_repeated_unpacked_enum:type_name -> FooEnum
	12, // 9: FooMessage.f_timestamp:type_name -> google.protobuf.Timestamp
	13, // 10: FooMessage.f_duration:type_name -> google.protobuf.Duration
	10, // 11: BazMessage.nested:type_name -> BazMessage.Nested
	2,  // 12: RepeatedMessage.bar_message:type_name -> BarMessage
	6,  // 13: EmptyMessageWithField.empty_message:type_name -> EmptyMessage
	11, // 14: BazMessage.Nested.f_nested:type_name -> BazMessage.Nested.NestedMessage
...
func file_test_reader_proto3_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_test_reader_proto3_proto_msgTypes[6].Exporter = func(v any, i int) any {
			switch v := v.(*OnlyOneOfField); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_test_reader_proto3_proto_msgTypes[9].Exporter = func(v any, i int) any {
	...
	file_test_reader_proto3_proto_msgTypes[6].OneofWrappers = []any{
		(*OnlyOneOfField_F1)(nil),
		(*OnlyOneOfField_F2)(nil),
		(*OnlyOneOfField_F3)(nil),
	}
	type x struct{}
